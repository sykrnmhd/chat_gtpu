...
(function dartProgram() {
  ...
  var A = {JS_CONST: function JS_CONST() {
    ...
    main() {
      var countData, recordButton, calculateButton, resetButton,
        t1 = type$.int,
        t2 = type$.double,
        payrollSystem = new A.PayrollManagementSystem(A.LinkedHashMap_LinkedHashMap$_empty(t1, t2)),
        storedData = window.localStorage.getItem("workingHoursMap");
      if (storedData != null)
        payrollSystem.set$workingHoursMap(A.LinkedHashMap_LinkedHashMap$from(type$.Map_dynamic_dynamic._as(B.C_JsonCodec.decode$1(0, storedData)), t1, t2));
      countData = window.localStorage.getItem("accumulationCount");
      if (countData != null)
        payrollSystem.accumulationCount = A._asInt(B.C_JsonCodec.decode$1(0, countData));
      t1 = document;
      recordButton = t1.querySelector("#recordButton");
      calculateButton = t1.querySelector("#calculateButton");
      resetButton = t1.querySelector("#resetButton");
      if (recordButton != null) {
        t1 = J.get$onClick$x(recordButton);
        t2 = t1.$ti;
        A._EventStreamSubscription$(t1._target, t1._eventType, t2._eval$1("~(1)?")._as(new A.main_closure(payrollSystem)), false, t2._precomputed1);
      }
      if (calculateButton != null) {
        t1 = J.get$onClick$x(calculateButton);
        t2 = t1.$ti;
        A._EventStreamSubscription$(t1._target, t1._eventType, t2._eval$1("~(1)?")._as(new A.main_closure0(payrollSystem)), false, t2._precomputed1);
      }
      if (resetButton != null) {
        t1 = J.get$onClick$x(resetButton);
        t2 = t1.$ti;
        A._EventStreamSubscription$(t1._target, t1._eventType, t2._eval$1("~(1)?")._as(new A.main_closure1(payrollSystem)), false, t2._precomputed1);
      }
    },
    PayrollManagementSystem: function PayrollManagementSystem(t0) {
      this.workingHoursMap = t0;
      this.accumulationCount = 0;
    },
    main_closure: function main_closure(t0) {
      this.payrollSystem = t0;
    },
  ...
  A.ListIterable.prototype = {
    get$iterator(_) {
      var t1 = this._parent;
      return new A.ListIterator(this, t1.get$length(t1), A._instanceType(this)._eval$1("ListIterator<ListIterable.E>"));
    }
  };
  ...
  A.MapBase.prototype = {
    forEach$1(receiver, action) {
      ...
      for (t2 = J.get$iterator$a(this.get$keys(receiver)), t1 = t1._eval$1("MapBase.V"); t2.moveNext$0();) {
        key = t2.get$current();
  ...
  A.PayrollManagementSystem.prototype = {
    resetWorkingHours$0() {
      this.workingHoursMap.clear$0(0);
      this.accumulationCount = 0;
      A.print("Working hours reset.");
    },
    set$workingHoursMap(workingHoursMap) {
      this.workingHoursMap = type$.Map_int_double._as(workingHoursMap);
    }
  };
  A.main_closure.prototype = {
    call$1(_) {
      var t1, t2, employeeIdInput, timeInElement, timeOutElement, timeIn, timeOut, employeeId, t3, _null = null;
      type$.MouseEvent._as(_);
      t1 = document;
      t2 = type$.nullable_InputElement;
      employeeIdInput = t2._as(t1.querySelector("#employeeId"));
      timeInElement = t2._as(t1.querySelector("timeIn"));
      timeOutElement = t2._as(t1.querySelector("timeOut"));
      if (timeInElement == null)
        timeIn = _null;
      else {
        t1 = timeInElement.valueAsNumber;
        timeIn = t1 == null ? _null : t1;
      }
      if (timeOutElement == null)
        timeOut = _null;
      else {
        t1 = timeOutElement.valueAsNumber;
        timeOut = t1 == null ? _null : t1;
      }
      if (employeeIdInput == null)
        employeeId = _null;
      else {
        t1 = employeeIdInput.valueAsNumber;
        employeeId = t1 == null ? _null : B.JSNumber_methods.toInt$0(t1);
      }
      timeOut.toString;
      timeIn.toString;
      t1 = this.payrollSystem;
      if (employeeId != null && true) {
        t2 = t1.workingHoursMap;
        if (t2.$index(0, employeeId) == null)
          t2.$indexSet(0, employeeId, 0);
        t2 = t1.workingHoursMap;
        t3 = t2.$index(0, employeeId);
        if (t3 == null)
          t3 = 0;
        if (typeof t3 !== "number")
          return t3.$add();
        t2.$indexSet(0, employeeId, t3 + (timeOut - timeIn));
        A.print("Working hours recorded for Employee " + A.S(employeeId) + ": " + A.S(t1.workingHoursMap.$index(0, employeeId)) + " hours");
      } else
        A.print("Invalid input. Please provide both Employee ID and Hours Worked.");
    },
    $signature: 1
  };
  A.main_closure0.prototype = {
    call$1(_) {
      var t1, calculateEmployeeIdInput, employeeId, t2, hoursWorked, grossSalary, epfContribution, t3, t4, t5, resultGrossElement, resultNetElement;
      type$.MouseEvent._as(_);
      t1 = document;
      calculateEmployeeIdInput = type$.nullable_InputElement._as(t1.querySelector("#calculateEmployeeId"));
      if (calculateEmployeeIdInput == null)
        employeeId = null;
      else {
        t2 = calculateEmployeeIdInput.valueAsNumber;
        employeeId = t2 == null ? null : B.JSNumber_methods.toInt$0(t2);
      }
      t2 = this.payrollSystem;
      if (employeeId != null) {
        hoursWorked = t2.workingHoursMap.$index(0, employeeId);
        if (hoursWorked == null)
          hoursWorked = 0;
        grossSalary = hoursWorked * 6;
        epfContribution = grossSalary * 0.11;
        t3 = A.S(employeeId);
        A.print("Employee " + t3 + " Salary Details:");
        A.print("Hours Worked: " + A.S(hoursWorked) + " hours");
        t4 = A.S(grossSalary);
        A.print("Gross Salary (Before EPF): RM " + t4);
        A.print("EPF Contribution (11%): RM " + A.S(epfContribution));
        t5 = A.S(grossSalary - epfContribution);
        A.print("Net Salary (After EPF): RM " + t5);
        resultGrossElement = t1.querySelector("#resultGross");
        if (resultGrossElement != null)
          J.set$text$x(resultGrossElement, "Gross Salary for Employee " + t3 + ": RM " + t4);
        resultNetElement = t1.querySelector("#resultNet");
        if (resultNetElement != null)
          J.set$text$x(resultNetElement, "Net Salary for Employee " + t3 + ": RM " + t5);
        if (++t2.accumulationCount >= 22)
          t2.resetWorkingHours$0();
      } else
        A.print("Invalid input. Please provide Employee ID for salary calculation.");
    },
    $signature: 1
  };
  A.main_closure1.prototype = {
    call$1(_) {
      type$.MouseEvent._as(_);
      this.payrollSystem.resetWorkingHours$0();
    },
    $signature: 1
  };
  (function aliases() {
  ...
  (function inheritance() {
    ...
    _inheritMany(A.Object, [A.JS_CONST, J.Interceptor, J.ArrayIterator, A.Error, A.Iterable, A.ListIterator, A.TypeErrorDecoder, A.NullThrownFromJavaScriptException, A._StackTrace, A.Closure, A.MapBase, A.LinkedHashMapCell, A.LinkedHashMapKeyIterator, A.Rti, A._FunctionParameters, A._Type, A._TimerImpl, A.AsyncError, A._FutureListener, A._Future, A._AsyncCallbackEntry, A.Stream, A._Zone, A.Codec, A.Converter, A.StackOverflowError, A._Exception, A.FormatException, A.Null, A._StringStackTrace, A.StringBuffer, A.EventStreamProvider, A._EventStreamSubscription, A.PayrollManagementSystem]);
    _inheritMany(J.Interceptor, [J.JSBool, J.JSNull, J.JavaScriptObject, J.JSNumber, J.JSString]);
    _inheritMany(J.JavaScriptObject, [J.LegacyJavaScriptObject, J.JSArray, A.EventTarget, A.DomException, A.Event, A._Storage_JavaScriptObject_MapMixin]);
    ...
    _inheritMany(A.Closure2Args, [A.initHooks_closure0, A.LinkedHashMap_LinkedHashMap$from_closure, A.MapBase_mapToString_closure, A.Storage_keys_closure]);
  ...
  var init = {
    ...
    mangledNames: {},
    types: ["~()", "~(MouseEvent)", "~(~())", "Null()", "@(@)", "@(@,String)", "@(String)", "Null(@)", "Null(~())", "_Future<@>(@)", "~(@,@)", "~(Object?,Object?)", "~(String,String)", "~(Event)"],
    interceptorsByTag: null,
    leafTags: null,
    arrayRti: Symbol("$ti")
  };
  A._Universe_addRules(init.typeUniverse, JSON.parse('{"PlainJavaScriptObject":"LegacyJavaScriptObject","UnknownJavaScriptObject":"LegacyJavaScriptObject","JavaScriptFunction":"LegacyJavaScriptObject","AbortPaymentEvent":"Event","ExtendableEvent":"Event","AElement":"SvgElement","GraphicsElement":"SvgElement","AudioElement":"HtmlElement","MediaElement":"HtmlElement","Window":"EventTarget","PointerEvent":"MouseEvent","CompositionEvent":"UIEvent","MathMLElement":"Element","HtmlDocument":"Node","Document":"Node","JSBool":{"bool":[],"TrustedGetRuntimeType":[]},"JSNull":{"TrustedGetRuntimeType":[]},"JSArray":{"List":["1"],"Iterable":["1"]},"JSUnmodifiableArray":{"JSArray":["1"],"List":["1"],"Iterable":["1"]},"JSNumber":{"double":[],"num":[]},"JSInt":{"double":[],"int":[],"num":[],"TrustedGetRuntimeType":[]},"JSNumNotInt":{"double":[],"num":[],"TrustedGetRuntimeType":[]},"JSString":{"String":[],"TrustedGetRuntimeType":[]},"LateError":{"Error":[]},"EfficientLengthIterable":{"Iterable":["1"]},"ListIterable":{"Iterable":["1"]},"NullError":{"TypeError":[],"Error":[]},"JsNoSuchMethodError":{"Error":[]},"UnknownJsTypeError":{"Error":[]},"_StackTrace":{"StackTrace":[]},"Closure":{"Function":[]},"Closure0Args":{"Function":[]},"Closure2Args":{"Function":[]},"TearOffClosure":{"Function":[]},"StaticClosure":{"Function":[]},"BoundClosure":{"Function":[]},"_CyclicInitializationError":{"Error":[]},"RuntimeError":{"Error":[]},"JsLinkedHashMap":{"MapBase":["1","2"],"Map":["1","2"],"MapBase.K":"1","MapBase.V":"2"},"LinkedHashMapKeyIterable":{"Iterable":["1"]},"_Error":{"Error":[]},"_TypeError":{"TypeError":[],"Error":[]},"_Future":{"Future":["1"]},"AsyncError":{"Error":[]},"_Zone":{"Zone":[]},"_RootZone":{"_Zone":[],"Zone":[]},"MapBase":{"Map":["1","2"]},"_JsonMap":{"MapBase":["String","@"],"Map":["String","@"],"MapBase.K":"String","MapBase.V":"@"},"_JsonMapKeyIterable":{"ListIterable":["String"],"Iterable":["String"],"ListIterable.E":"String"},"JsonCodec":{"Codec":["Object?","String"]},"double":{"num":[]},"int":{"num":[]},"AssertionError":{"Error":[]},"TypeError":{"Error":[]},"ArgumentError":{"Error":[]},"RangeError":{"Error":[]},"IndexError":{"Error":[]},"UnsupportedError":{"Error":[]},"UnimplementedError":{"Error":[]},"ConcurrentModificationError":{"Error":[]},"StackOverflowError":{"Error":[]},"_StringStackTrace":{"StackTrace":[]},"MouseEvent":{"Event":[]},"HtmlElement":{"Element":[],"EventTarget":[]},"AnchorElement":{"Element":[],"EventTarget":[]},"AreaElement":{"Element":[],"EventTarget":[]},"Element":{"EventTarget":[]},"FormElement":{"Element":[],"EventTarget":[]},"InputElement":{"Element":[],"EventTarget":[]},"Node":{"EventTarget":[]},"SelectElement":{"Element":[],"EventTarget":[]},"Storage":{"MapBase":["String","String"],"Map":["String","String"],"MapBase.K":"String","MapBase.V":"String"},"UIEvent":{"Event":[]},"_EventStream":{"Stream":["1"]},"_ElementEventStreamImpl":{"_EventStream":["1"],"Stream":["1"]},"SvgElement":{"Element":[],"EventTarget":[]}}'));
  A._Universe_addErasedTypes(init.typeUniverse, JSON.parse('{"EfficientLengthIterable":1,"Converter":2}'));
  var string$ = {

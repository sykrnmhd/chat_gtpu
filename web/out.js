// Generated by dart2js (NullSafetyMode.sound, csp, deferred-serialization, intern-composite-values), the Dart to JavaScript compiler version: 3.1.5.
...
(function dartProgram() {
  ...
  A.main_closure.prototype = {
    call$1(_) {
      var t1, t2, employeeIdInput, hoursInput, employeeId, hours, t3, _null = null;
      type$.MouseEvent._as(_);
      t1 = document;
      t2 = type$.nullable_InputElement;
      employeeIdInput = t2._as(t1.querySelector("#employeeId"));
      hoursInput = t2._as(t1.querySelector("#hoursWorked"));
      ...
      if (hoursInput == null)
        ...
        t1 = hoursInput.valueAsNumber;
        hours = t1 == null ? _null : t1;
      }
      ...
      if (employeeId != null && hours != null) {
        ...
        if (typeof t3 !== "number")
          return t3.$add();
        t2.$indexSet(0, employeeId, t3 + hours);
